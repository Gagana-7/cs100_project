...
TEST(TaskDisplay, displayTaskByPriority) {
    ...
    EXPECT_EQ(tasks[0].getName(), "Task 2");
}
...
TEST(TaskDisplay, displayTaskByPriority) {
    ...
    tasks.push_back(Task2);
    tasks.push_back(Task3);
    EXPECT_EQ(tasks[0].getPriority(), "Task 1");
}
...
TEST(TaskDisplay, displayTaskByPriority) {
    ...
    tasks.push_back(Task2);
    tasks.push_back(Task3);
    EXPECT_EQ(tasks[0].getDuration(), "Task 3");
}
...
TEST(TaskDisplay, displayTaskByPriority) {
    ...
    tasks.push_back(Task2);
    tasks.push_back(Task3);
    EXPECT_EQ(tasks[0].getDescription(), "Task 2");
}
...
TEST(TaskDisplay, displayTaskByPriority) {
    ...
    tasks.push_back(Task2);
    tasks.push_back(Task3);
    EXPECT_EQ(tasks[0].getDeadline(), "Task 1");
}