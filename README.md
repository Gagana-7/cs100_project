...
>
> We tested code coverage of our functions through gcov and lcov. The reason we don't have 100% of driverTask.cpp is because it is detecting the deafault cases in switch, which are needed in case the user inputs an option not present.
>
